...
Checked against a `-tags server` build driven headlessly (Chromium, 1440×900,
`test/smoke/lib/harness.mjs` + `internal/teststubchild`) and the `.pen` frames
`rRx2E` (timeline) / `ApsQe` (empty state).
